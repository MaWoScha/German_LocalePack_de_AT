 ...
 */
class German_LocalePackAt_Block_System_Config_Form_Fieldset_Extensions
    extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
		...
		$html .= "<h3 style='margin-top:20px; margin-bottom:10xp;'>".$helper->__("Specific market adjustment for")." ".$helper->__("Austrian and European stores")."</h3>";
		$html .= "<dl>";
		...
		$html .= "<dt><b>Magento AT: Austrian Store</b> - <a href='https://github.com/integer-net/Magento-AT' target='_blank'>Configuration for Magento CE</a></dt>";
		$html .= "<dd>".$helper->__("Preconfigurated for the Austrian market")."</dd>";
		$html .= "<dt><b>nr-apps</b> - <a href='http://de.nr-apps.com/store/magento-at.html' target='_blank'>Magento AT</a></dt>";
		$html .= "<dd>".$helper->__("Preconfigurated for the Austrian market")."</dd>";
		$html .= "</dl>";
