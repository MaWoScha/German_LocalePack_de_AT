 ...
 */
class German_LocalePackAt_Block_System_Config_Form_Fieldset_Instructions
    extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        $nodepath = "modules/German_LocalePackAt";
    ...
    if (!array_key_exists("German_LocaleFallback", $modules)) {
        ...
        $html .= $helper->__("powered by")." <a href='http://blog.siempro.co/' target='_blank'>MaWoScha</a> ".$helper->__("and")." <a href='http://www.matthias-zeis.com/' target='_blank'>Matthias Zeis</a>";
        $html .= "</p>";
